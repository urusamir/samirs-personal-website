        ...
        <section className="relative w-full bg-[#000000] py-24 z-10 overflow-hidden" id="pricing">
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                    ...
                    {/* Hourly Plan */}
                    <div className="flex flex-col p-8 rounded-3xl bg-[#09090B] border border-white/10 relative transition-transform hover:-translate-y-2 duration-300">
                        <div className="mb-8">
                    ...
                    <div className="flex flex-col p-8 rounded-3xl bg-[#050B14] border border-[#2563EB]/50 shadow-[0_0_30px_rgba(37,99,235,0.15)] relative transition-transform hover:-translate-y-2 duration-300 transform md:-translate-y-4">
