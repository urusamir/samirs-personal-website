    ...
    return (
        <section id="scale" className="relative w-full bg-[#000000] pt-20 pb-40">
            <div className="max-w-4xl mx-auto px-8 w-full flex flex-col items-center justify-center text-center gap-12">
                ...
                <a href="https://tidycal.com/msamir5230/30-minute-meeting" target="_blank" rel="noreferrer" className="magnetic-btn relative overflow-hidden group bg-white text-black px-10 py-5 rounded-full font-heading font-bold text-xl tracking-tight transition-transform flex items-center justify-center gap-4 shadow-2xl shadow-white/20 w-full sm:w-auto hover:scale-105">
